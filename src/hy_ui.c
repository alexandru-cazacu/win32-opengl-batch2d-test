...
internal void hyui_button(const char* label)
{
    ...
    draw_quad_2c((vec2){ g_ui_context.cursor_x, g_ui_context.cursor_y }, (vec2){ 200, FONT_SIZE + g_ui_context.button_padding * 2 }, g_ui_context.frame_bg);
    draw_debug_text(label, g_ui_context.cursor_x + g_ui_context.button_padding, g_ui_context.cursor_y + g_ui_context.button_padding, hex_to_HyColor(fg));
...
internal void hyui_icon_button(HyTexture* icon)
{
    ...
    draw_quad_2c((vec2){ g_ui_context.cursor_x, g_ui_context.cursor_y }, (vec2){ FONT_SIZE + g_ui_context.button_padding * 2, FONT_SIZE + g_ui_context.button_padding * 2 }, g_ui_context.frame_bg);
    draw_quad_2tc(g_ui_context.cursor_x + g_ui_context.button_padding, g_ui_context.cursor_y + g_ui_context.button_padding, (vec2){ FONT_SIZE, FONT_SIZE }, icon, HyWhite);
